...
<body>
    ...
    <nav class="navbar navbar-light">
        <div class="container d-block">
            <a href="/navbaritem.php"><i class="bi bi-chevron-left"></i></a>
            <a class="navbar-brand ms-4" href="/navbaritem.php">
...
<div class="container">
    <div class="card mt-5">
        <div class="card-header">
            <h4 class="card-title">Menü Buton Düzenleme</h4>
        </div>
        <div class="card-body">


                                        <form class="form" action="itemedit.php" method="post">
