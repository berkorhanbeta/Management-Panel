...
<head>
    ...
    <title>Giriş | APPBeta Mobile</title>
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <center>
            <img src="assets/static/images/logo/appbeta-mor.png" width="50%" height="100%" />
            </center>
            <h1 class="auth-title">Hoşgeldiniz.</h1>
            <p class="auth-subtitle mb-5">Sisteme giriş yaparak uygulamanızı yönetmeye başlayabilirsiniz.</p>

            <form action="auth-login.php" method="post">
                <input type="hidden" name="giris_onay" value="2" />
                <div class="form-group position-relative has-icon-left mb-4">
                    <input name="username" type="text" class="form-control form-control-xl" placeholder="Kullanıcı Adınız">
                    <div class="form-control-icon">
                        <i class="bi bi-person"></i>
                    </div>
                </div>
                <div class="form-group position-relative has-icon-left mb-4">
                    <input name="password" type="password" class="form-control form-control-xl" placeholder="Şifreniz">
                    <div class="form-control-icon">
